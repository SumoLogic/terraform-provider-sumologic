...
- `tags` - (Optional) A map defining tag keys and tag values for the SLO. This field is in private beta and is not available until given access. To participate in the beta program, contact Sumo Logic support.
