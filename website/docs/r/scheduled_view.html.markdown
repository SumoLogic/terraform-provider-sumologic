...
- `data_tier` - (Optional) The data tier in which scheduled view will be created. If no value is supplied, scheduled view will be created in continuous tier. Other possible values are : "infrequent".
