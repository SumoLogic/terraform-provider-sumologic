		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet(tracingResourceName, "token"),
					resource.TestCheckResourceAttrSet(tracingResourceName, "base_url"),
					...
					resource.TestCheckResourceAttrSet(kinesisResourceName, "token"),
					resource.TestCheckResourceAttrSet(kinesisResourceName, "base_url"),
					...
					resource.TestCheckResourceAttrSet(otlpResourceName, "token"),
					resource.TestCheckResourceAttrSet(otlpResourceName, "base_url"),
